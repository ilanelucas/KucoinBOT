// Global variables
let socket;
const refreshRate = 1000; // milliseconds - réduit pour une mise à jour plus rapide
...
let balanceHistory = [];
let themeMode = 'dark';
let pendingAnimations = new Set(); // Pour suivre les animations en cours
let connectionAttempts = 0;
let maxConnectionAttempts = 5;
let reconnectDelay = 2000; // Délai initial de reconnexion en ms
let reconnectTimer = null;

// Cache pour les données des positions précédentes
const positionsCache = new Map();
// Indicateurs de performance pour surveiller les mises à jour
...
// Objets pour le suivi des mises à jour et l'optimisation
const pendingUpdates = {};
const animationQueue = [];
let animationFrameRequested = false;

// Configuration des transitions et des animations
